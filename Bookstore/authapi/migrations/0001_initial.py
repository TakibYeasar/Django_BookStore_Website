    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_one', models.CharField(blank=True, max_length=512, null=True, verbose_name='Address')),
                ('address_two', models.CharField(blank=True, max_length=512, null=True, verbose_name='Address')),
